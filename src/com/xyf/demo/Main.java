...
public class Main {
    ...
    public static void main(String[] args) {
            ...
            Person person2 = new Person(Integer.valueOf(id2), userName2, new ArrayList<String>());
            System.out.println("----欢迎玩家:" + person.getUserName());
            System.out.println("----欢迎玩家:" + person2.getUserName());
